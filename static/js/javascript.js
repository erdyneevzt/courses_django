 $(document).ready(function () {
         $('#add-human').submit(function (e) {
             ...
             $.ajax({
                method: 'POST',
                url : $(this).attr('action'), // show-three или show-four
                data: {
                    'name':$('#id_name').val(),
                ...
                success: function (data) {
                    ...
                    var table_row = '<tr><td>' +
                               data.name + '</td><td>' + data.surname + '</td><td>' +
                                ...
                                data.position + '</td><td>' + data.language + '</td><td>' +
                                data.salary + '</td></tr>';
 ...
 $(document).ready(function () {
        function ajax_setup(e) {
            ...
            $.ajax({
                method: 'GET',
                url : $(this).attr('href'), // show-three или show-four
                data: "",
                dataType: 'json',
                success: function (data) {
                    console.log(data);
 ...
 $(document).ready(function () {
        $('#id_email').on('blur', validate);    //id_name лежит в коде html где поле
        function validate() {
            var email = $('#id_email').val();   // Достаем имя из поля
            $.ajax({
                method: "GET",
